...
const graphene = require("@decentrawise/graphenejs-ws");
const {ChainTypes, ChainStore, FetchChain} = require("@decentrawise/graphenejs");
...
function connect() {
    return new Promise(resolve => {
        graphene.Apis.instance(config.apiNode, true)
